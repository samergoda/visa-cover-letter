  ...
  return (
    <Card>
      ...
      <CardContent className="grid grid-cols-2 gap-4 sm:grid-cols-3">
        <InfoRow label={tForm("travel.destinationCountry")} value={applicant.destination_country} />
        ...
        <InfoRow
          ...
          value={
            applicant.arrival_date ? format(new Date(applicant.arrival_date), "MMM d, yyyy") : null
          }
        />
        <InfoRow
        ...
        <InfoRow
          ...
          value={
            applicant.duration_of_stay ? `${applicant.duration_of_stay} ${t("values.days")}` : null
          }
        />
