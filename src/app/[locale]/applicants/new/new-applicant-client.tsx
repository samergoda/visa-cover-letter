...
export default function NewApplicantClient({
  hasDashboardAccess,
}: {
  ...
  const strings = {
    ...
    dashboardBtn: isAr ? "الذهاب إلى لوحة التحكم" : "Go to Dashboard",
  };
        ...
        {submitted ? (
          ...
          <Card className="border-green-500/20 shadow-2xl shadow-green-500/5 overflow-hidden transition-all duration-500 transform scale-100">
            ...
            <CardContent className="flex flex-col items-center gap-6 py-16 px-6 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto mt-6 justify-center">
                {hasDashboardAccess && (
                  <Button
                    size="lg"
                    variant="outline"
