...
export function buildCoverLetterPrompt(client: ClientInformation): string {
  const sections: string[] = [
    ...
    "- If a field is missing or empty, omit that topic entirely.",
    ...
    "- Output only the cover letter text, starting with a formal salutation and ending with a respectful closing and signature line using the applicant's full name.",
    "",
    "CLIENT DATA:",
